...
const Errors = require("../api/errors/subjectmanx-main-error.js");
...
const logger = LoggerFactory.get("SubjectmanxMainAbl");

class SubjectmanxMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuSubjectmanx",
        typeCode: "uu-subjectmanx-maing01",
        location: location,
...
module.exports = new SubjectmanxMainAbl();
