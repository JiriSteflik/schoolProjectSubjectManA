const Lsi = {
  ...
  about: {
    header: {
      ...
      en: "About application uuSubjectmanx",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní uuSubjectmanx.",
      en: "You can buy your own uuSubjectmanx.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci uuSubjectmanx.",
      en: "You don't have rights to initialize this uuSubjectmanx.",
    },
  },
